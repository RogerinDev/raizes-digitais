...
* **Core:** Inteligência Artificial Generativa (Integração com APIs de LLMs)
* **Arquitetura:** RAG (Retrieval-Augmented Generation)
* **Estruturação:** Bancos de Dados Vetoriais
* **Ajuste Fino:** Engenharia de Prompts Contextualizada
